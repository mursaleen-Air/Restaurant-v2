                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <motion.div
                            ...
                            className="group p-8 rounded-3xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                        >
                        ...
                        <motion.div
                            ...
                            className="group p-8 rounded-3xl bg-gradient-to-br from-secondary to-teal-400 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform"
                        >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                key={i}
                                className="group relative rounded-3xl overflow-hidden bg-white shadow-lg card-hover"
                            >
